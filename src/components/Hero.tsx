...
const Hero = () => {
  ...
  // Client avatar URLs - using smaller images
  const avatars = [
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      {/* Lazy load decorative floating shapes */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Heading - simplified animations */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-display font-bold leading-[0.95] mb-6 animate-fade-in">
          ...
          {/* Trust indicators */}
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {/* Google Reviews */}
            ...
            {/* Client avatars - lazy loaded images */}
