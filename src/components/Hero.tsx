...
const Hero = () => {
  ...
  return <section ref={containerRef} className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      <FloatingShapes />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                <motion.h1 className="text-5xl sm:text-6xl md:text-7xl font-display font-bold leading-[0.95] mb-6">
                  ...
                  delay: 0.3
                    ...
                    <span className="text-gradient glow-text relative">
                      websites
                      <motion.span className="absolute -right-2 -top-2" initial={{
                      scale: 0,
                      rotate: -20
                    }} animate={{
                      scale: 1,
            ...
            delay: 0.3
              ...
              <div className="relative">
                ...
                duration: 0.3
              }} className="glass-strong rounded-2xl overflow-hidden shadow-2xl" style={{
                perspective: "1000px"
              }}>
                  {/* Browser header */}
