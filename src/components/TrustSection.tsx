...
const clientsRow2: Client[] = [
  ...
  { name: "Uzdrav Telo", image: "/img/uzdravtelo_sk-logo_gradient.png", url: "https://www.uzdravtelo.sk/" },
  { name: "Yogatree", image: "/img/yogatree2-300x243.png", url: "https://yogatree.cz/" },
