...
const defaultReviews: Review[] = [
  {
    ...
    quote: "Spolupráce s WebOptim předčila naše očekávání. Konverzní poměr vzrostl o 200% během prvního čtvrtletí.",
    rating: 5,
  },
  {
    name: "Jana Svobodová",
    ...
    quote: "E-shop, který nám vytvořili, je neuvěřitelně intuitivní. Prodeje se od spuštění zdvojnásobily!",
    rating: 5,
  },
  {
    name: "Petr Horák",
    ...
    quote: "Výjimečný design a bezchybné provedení. Dokonale pochopili naši vizi a dodali víc, než jsme čekali.",
    rating: 5,
  },
];
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {reviews.map((review, index) => (
            <motion.div
              ...
              className="glass-strong rounded-2xl p-8 relative group hover:border-primary/30 transition-all duration-300 border border-border/50"
            >
              {/* Quote Icon */}
