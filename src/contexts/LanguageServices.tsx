...
const translations: Record<string, ServicesLang> = {
  EN: {
    hero: {
      badge: "What We Offer",
      title: "Our Services",
    ...
    services: {
      ...
      ecommerce: {
        title: "E-Commerce",
        description:
          "Powerful WooCommerce stores with seamless checkout experiences.",
        features: [
          "WooCommerce & Shoptet",
      ...
      ppc: {
        ...
        description:
          "Strategic paid campaigns that deliver measurable results.",
        features: [
          "Google Ads",
          "Social Ads",
          "Remarketing",
      ...
      digitalization: {
        ...
        description:
          "Automate your business with modern tools and workflows.",
        features: [
          "CRM implementation",
          "Workflow automation",
          "Cloud integrations",
      ...
      graphic: {
        ...
        description:
          "Eye-catching digital and print design that strengthens your brand.",
        features: [
          "Corporate identity",
  ...
  SK: {
    hero: {
      ...
      title: "Naše služby",
      subtitle:
        "Komplexné digitálne riešenia prispôsobené potrebám vášho biznisu.",
    },
    services: {
      webDev: {
        ...
        description:
          "Webové stránky na mieru postavené na WordPress a Oxygen Builderi.",
        features: [
          "WordPress & Oxygen Builder",
      ...
      ecommerce: {
        ...
        description:
          "Výkonné WooCommerce e-shopy s dôrazom na konverzie.",
        features: [
          "WooCommerce & Shoptet",
          "Úprava pokladne",
          "Platobné brány",
      ...
      seo: {
        title: "SEO služby",
        description:
          "Zvýšime vašu viditeľnosť vo vyhľadávačoch.",
        features: [
      ...
      ppc: {
        title: "PPC reklama",
        description:
          "Platené kampane, ktoré prinášajú výsledky.",
        features: [
          "Google Ads",
          "Sociálne siete",
          "Remarketing",
      ...
      digitalization: {
        title: "Digitalizácia",
        description:
          "Automatizácia procesov a nástrojov.",
        features: [
          "CRM systémy",
      ...
      graphic: {
        ...
        description:
          "Vizuály, ktoré podporujú vašu značku.",
        features: [
          "Firemná identita",
          "Online & print dizajn",
...
export const ServicesLanguageProvider = ({ children }: { children: React.ReactNode }) => {
  const { language } = useLanguage();

  return (
    <ServicesLanguageContext.Provider value={translations[language]}>
      {children}
    </ServicesLanguageContext.Provider>
  );
};
...
export const useServicesLang = () => {
  ...
  if (!ctx) {
    throw new Error("useServicesLang must be used inside ServicesLanguageProvider");
  }
  return ctx;
};
