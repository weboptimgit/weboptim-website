...
const translations: Record<string, BuildingWebsiteLang> = {
  ...
  SK: {
    ...
    packages: [
      {
        name: "Starter",
        description: "Ideálne pre malé firmy",
        price: "Od 1 500 €",
        features: ["5–7 podstránok", "Responzívny dizajn", "Základné SEO", "Kontaktný formulár", "1 mesiac podpory"],
      },
      {
        name: "Professional",
        description: "Pre rastúci biznis",
        price: "Od 3 500 €",
        features: ["10–15 podstránok", "CMS", "Pokročilé SEO", "Analytika", "3 mesiace podpory", "Blog"],
        popular: true,
      },
      {
        name: "Enterprise",
        description: "Riešenie na mieru",
        price: "Individuálne",
        features: ["Neobmedzene stránok", "Custom funkcie", "API integrácie", "Prioritná podpora", "Výkonové SLA", "Dedikovaný tím"],
      },
    ],
    ...
    packages: [
      {
        ...
        price: "Od 1 500 €",
        features: ["5–7 podstránek", "Responzivní design", "Základní SEO", "Kontaktní formulář", "1 měsíc podpory"],
      },
      {
        name: "Professional",
        description: "Pro rostoucí byznys",
        price: "Od 3 500 €",
        features: ["10–15 podstránek", "CMS", "Pokročilé SEO", "Analytika", "3 měsíce podpory", "Blog"],
        popular: true,
      },
      {
        name: "Enterprise",
        ...
        price: "Individuálně",
        features: ["Neomezeně stránek", "Custom funkce", "API integrace", "Prioritní podpora", "Výkonové SLA", "Dedikovaný tým"],
      },
    ],
