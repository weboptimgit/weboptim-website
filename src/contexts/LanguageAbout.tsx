...
const aboutTranslations: Record<Language, Dict> = {
  ...
  SK: {
    ...
    "about.team.peter.role": "Zakladateľ & Lead Developer",
    "about.team.peter.bio": "Špecialista na vývoj webov so zameraním na WordPress, Oxygen Builder a moderné technológie.",
    "about.team.lucia.role": "Creative Director",
    "about.team.lucia.bio": "Dizajnérka, ktorá oživuje značky silnou vizuálnou identitou a UX prístupom.",
    "about.team.martin.role": "SEO & Marketing Lead",
    "about.team.martin.bio": "Marketing postavený na dátach — SEO stratégie a PPC kampane s merateľným dopadom.",
    "about.team.jana.role": "UX/UI Designer",
    "about.team.jana.bio": "Navrhuje intuitívne rozhrania a zážitky, ktoré zvyšujú konverzie a bavia používateľov.",
    "about.team.tomas.role": "Full-Stack Developer",
    "about.team.tomas.bio": "Moderné frameworky a škálovateľná architektúra — robustné aplikácie od základu.",
