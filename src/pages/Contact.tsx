              ...
              <div className="glass p-8 rounded-2xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input id="company" name="company" value={formData.company} onChange={handleChange} placeholder="Your Company" className="bg-background/50" />
                  </div>
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium mb-2">
                      Your Message
                    </label>
                    <Textarea id="message" name="message" value={formData.message} onChange={handleChange} placeholder="Tell us about your project..." rows={5} required className="bg-background/50 resize-none" />
                  </div>
              ...
              <div className="space-y-4">
                ...
                delay: 0.5 + index * 0.1
                    ...
                    <div>
                      ...
                      {item.href ? <a href={item.href} className="font-medium hover:text-primary transition-colors">
                          {item.value}
                        </a> : <p className="font-medium">{item.value}</p>}
                    </div>
                  </motion.div>)}
              </div>
