...
const getTechColor = (tech: string): string => {
  ...
  if (["stripe", "pdf generation", "pdf"].includes(techLower)) {
...
const CaseStudy = () => {
  ...
  // Fallbacks (aby nič nikdy nepadlo)
                  ...
                  <div className="flex flex-wrap gap-2">
                    {technologies.map((tech, index) => (
                      <motion.span
                        ...
                        className={`px-3 py-1.5 rounded-lg text-sm font-medium border backdrop-blur-sm ${getTechColor(
                          tech
                        )}`}
                      >
                        {tech}
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {results.map((result, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="mb-3 flex justify-center">{renderMetric()}</div>
