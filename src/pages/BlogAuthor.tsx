...
import { Calendar, Clock, ArrowRight, Home, ChevronRight, User, ArrowLeft } from "lucide-react";
        ...
        <div className="min-h-screen bg-background">
          ...
          <div className="pt-32 pb-16 px-4 text-center">
            ...
            >
              ...
              <h1 className="text-4xl font-bold mb-4">{t("blogAuthor.notFound.title")}</h1>
              <p className="text-muted-foreground mb-8">{t("blogAuthor.notFound.subtitle")}</p>
              <Link to="/blog">
          ...
          <div className="container mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                {t("blogAuthor.subtitle").replace("{count}", posts.length.toString())}
              </p>
            </motion.div>
          </div>
        </section>
                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-primary flex items-center gap-1 text-sm font-medium group-hover:gap-2 transition-all">
                          {t("blogAuthor.readMore")} <ArrowRight className="w-4 h-4" />
                        </span>
                      </div>
                    </div>
                  </Link>
