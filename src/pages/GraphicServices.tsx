    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-xl">{t("graphic.subtitle")}</p>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-6">
          ...
          >
            <span className="text-primary font-medium text-sm tracking-wider uppercase mb-4 block">What We Create</span>
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">
              Full-Service <span className="text-gradient">Graphic Design</span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              We pride ourselves on creating digital content that not only stands out but also demonstrably fulfils its
              purpose.
            </p>
          </motion.div>
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">Choose the package that fits your needs</p>
          </motion.div>
