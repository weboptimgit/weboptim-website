...
const graphicFaqs = [{
  ...
  answer: "We deliver all industry-standard formats including AI, EPS, PDF, PNG, JPG, and SVG. For print projects, we provide press-ready files with proper bleed and color profiles."
}, {
  question: "How many revision rounds are included?",
  answer: "Our packages include 2-3 revision rounds depending on the project scope. We work closely with you to ensure the final design meets your vision."
}, {
  question: "Do you handle printing as well?",
  answer: "Yes, we can manage the entire print process from design to delivery. We work with trusted print partners to ensure quality and competitive pricing."
}, {
  question: "What's your typical turnaround time?",
  answer: "Simple projects like business cards take 3-5 business days. Complex projects like brand identity packages take 2-4 weeks. Rush delivery is available for urgent needs."
}];
...
const pricingPlans = [{
  ...
  features: ["Logo design (3 concepts)", "Business card & letterhead", "Social media kit", "Brand guidelines", "Print-ready files", "3 revision rounds"],
  popular: true
}, {
  name: "Enterprise",
  price: "1,999",
  description: "Full brand identity system",
  features: ["Complete logo system", "Full stationery suite", "Marketing materials", "Packaging design", "Brand book (20+ pages)", "Unlimited revisions", "Priority support"],
  popular: false
}];
const GraphicServices = () => {
  const {
  ...
  return <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            duration: 0.6
              ...
              <motion.div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/10 border border-purple-500/20 mb-6" initial={{
              opacity: 0,
              scale: 0.9
            }} animate={{
              opacity: 1,
            ...
            delay: 0.2
              ...
              <div className="glass-strong rounded-2xl p-6 border border-border/50">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {graphicServices.map((service, index) => <motion.div key={service.name} initial={{
                  opacity: 0,
                  y: 20
                }} animate={{
                  opacity: 1,
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            delay: index * 0.1
                ...
                {plan.popular && <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-sm font-medium text-white">
                    Most Popular
                  </div>}
                ...
                <ul className="space-y-3 mb-8">
                  {plan.features.map((feature, i) => <li key={i} className="flex items-center gap-3 text-muted-foreground">
      ...
      {/* FAQ */}
      <ServiceFAQ faqs={graphicFaqs} serviceName="Graphic Design Services" />
