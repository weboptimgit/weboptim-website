      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-center">
          ...
          >
            ...
            <div 
              id="social-post"
              className="w-full h-full flex flex-col items-center p-16 relative"
              style={{
            ...
            >
              ...
              <div className="relative z-10 flex items-center gap-6 mb-auto pt-4">
                <img 
                  src="/img/weboptim-profile-pic.png" 
                  alt="WebOptim Logo" 
                  className="w-20 h-20 rounded-full shadow-xl ring-4 ring-white/10"
                />
                <div className="inline-flex items-center gap-2 bg-white/5 backdrop-blur-sm border border-white/10 px-5 py-2.5 rounded-full">
              ...
              {/* Floating icons */}
              <div className="absolute top-48 left-24 p-4 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
                <Rocket className="w-10 h-10 text-[#42c8f2]" />
              </div>
              <div className="absolute top-56 right-32 p-4 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10">
              ...
              <div className="relative z-10 text-center max-w-3xl my-auto">
                {/* Heading */}
                <h2 
                  className="text-7xl font-display font-bold text-center mb-8 leading-tight"
                  style={{
                ...
                {/* Subtext */}
                <p className="text-2xl text-white/70 text-center leading-relaxed mb-6">
